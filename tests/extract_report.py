...
def kraken_report(summary_file,header_row,sample_names):
    # Parsing the file
    ...
    #kraken_summary.to_csv("filtered_kreport.tsv",header=True, index=False, sep="\t")
...
if __name__=="__main__":
    ...
    summary=kraken_report(args.input,header_row,sample_names)
